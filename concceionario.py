#Tenemos una conccecionaria de veicuhlos, en la cual se va a poder hacer la compra y venta, }
#gestionamos los veiculos, cuales son los que estan disponible su precio, etc.
...
class Cliente:
    ...
    def cleinte_registrado(self):
         print(f"Bienvenido a la conccecionaria: {self.nombre}")

    
    def Colleción(self,Garage = []):
        self.Garage = Garage
        print(self.Garage)
         
Comprador1 = Cliente("Don Juan")
Comprador1.cleinte_registrado()
Comprador1.Colleción(Auto_1)
